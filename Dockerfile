...
#PORT EXPOSE
EXPOSE 8080
WORKDIR /var/lib/jenkins/workspace/SONAR-QUBE-jenkins-pipeline/target/target/
RUN cp  /var/lib/jenkins/workspace/SONAR-QUBE-jenkins-pipeline/target/*.war /usr/local/tomcat/webapps/app.war
